...
const Profile = () => {
  ...
  return (
    <>
      <h2 className="mb-3 ps-3 text-2xl font-extrabold text-gray-900">My Profile:</h2>


      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative drop-shadow-2 flex justify-center my-3">
              <img src={dataa?.data?.profileImg?.includes("user") ?`${baseURL}/users/${dataa?.data?.profileImg}` :dataa?.data?.profileImg}  alt="profile" />
            </div>
