...
import useDeleteBrand from "../../hook/Brand/useDeleteBrand";
import { NavLink } from "react-router-dom";
import { baseURL } from "../../API/mainBaseURL";
const BrandTableRow = ({ brand }) => {
  const [open, handleOpen, handelDeleteBrand] = useDeleteBrand();
  return (
    <>
      <Dialog
        open={open}
        ...
        <DialogFooter>
          ...
          <Button
            ...
            onClick={() => handelDeleteBrand(brand._id)}>
            <span>Confirm</span>
          </Button>
        </DialogFooter>
      </Dialog>
      <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        ...
        <div className="col-span-1 flex items-center gap-1">
          <NavLink to={`/dashboard/editbrand/${brand._id}`}>
