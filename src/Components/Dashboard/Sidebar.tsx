        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/dashboard/products" || pathname.includes("products")
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/dashboard/category" || pathname.includes("category")
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/dashboard/brands" || pathname.includes("brand")
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/dashboard/subcategory" || pathname.includes("subcategory")
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
