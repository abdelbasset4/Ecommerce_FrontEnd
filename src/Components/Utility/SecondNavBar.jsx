        ...
        <MenuList className="hidden max-w-screen-xl rounded-xl lg:block ">
            <ul className="grid grid-cols-5 gap-y-2">
                ...
                <ul className="ms-4">
                    ...
                    <li className="text-black font-semibold ms-3 mt-3">Watches & Wearables</li>
                </ul>
                <ul className="ms-4">
                    ...
                    <li className="text-black font-semibold ms-3 mt-3">Sunglasses & Frames</li>
                </ul>
                ...
                <ul>
                    ...
                    <li className="text-black font-semibold ms-3 mt-3">Handbags & Wallets</li>
                </ul>
            </ul>
        </MenuList>
      </Menu>
...
function NavListCategory() {
    ...
    const renderItems = navListCategory.map(({ title }) => (
      <a href="#" key={title}>
        <MenuItem>
          <Typography variant="h6" color="blue-gray" className="mb-0 text-sm font-light ">
            {title}
          </Typography> 
        </MenuItem>
      </a>
